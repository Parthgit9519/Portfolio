...
const categories = ["All", "Web App", "Landing Page", "Browser Extension", "AI Web App"];
      ...
      <section className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 px-6 py-20 overflow-hidden">
         ...
         <div className="container mx-auto">
            ...
            <div className="text-center mb-16 animate-fadeInDown">
               ...
               <p className="mt-3 text-lg text-slate-600 max-w-2xl mx-auto animate-fadeInUp" style={{animationDelay: '0.2s'}}>
            ...
            <div className="grid grid-cols-12 gap-4 items-center mb-12">
               {/* Search */}
               <div className="col-span-12 md:col-span-6 lg:col-span-5 animate-scaleIn" style={{animationDelay: '0.3s'}}>
               ...
               {/* Sort */}
               <div className="col-span-12 lg:col-span-2 flex justify-start lg:justify-end animate-scaleIn" style={{animationDelay: '0.5s'}}>
               ...
               {filtered.map((project, idx) => (
                  ...
                  >
                     ...
                     <div className={classNames(
                        ...
                        hoveredIdx === idx && "from-blue-500/40 via-indigo-500/40 to-fuchsia-500/40"
                     )} />
            ...
            {filtered.length === 0 && (
               <div className="text-center py-16 animate-fadeInUp">
                  <p className="text-2xl font-semibold text-slate-500">No projects found</p>
